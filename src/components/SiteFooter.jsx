    ...
    <footer className="bg-[#050607] px-6 py-16 text-white sm:px-10 lg:px-16">
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div><p className="mb-4 text-xs uppercase tracking-[0.18em] text-white/40">Contact</p><div className="flex flex-col gap-3 text-sm text-white/70"><span>Jakarta Design Center 4th Floor SR 15<br />Jl Gatot Subroto 53, Slipi, Jakarta 10260 Indonesia</span><a href={whatsappHref} target="_blank" rel="noreferrer">{phoneDisplay}</a><a href={`mailto:${contactEmail}`}>{contactEmail}</a></div></div>
        </div>
