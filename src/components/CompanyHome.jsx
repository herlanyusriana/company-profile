...
export default function CompanyHome() {
  ...
  return (
    <main id="top" className="overflow-hidden bg-white text-zinc-950">
      ...
      <section className="bg-[#f5f5f2] px-5 py-24 sm:px-8 lg:px-14 lg:py-28">
        <div className="mx-auto max-w-[1440px]">
          <p className="mb-5 text-center text-xs font-semibold uppercase tracking-[0.25em] text-zinc-500">Our partners</p>
          <h2 className="mb-14 text-center text-4xl font-medium tracking-[-0.045em] sm:text-5xl">Trusted brands we carry.</h2>
          <div className="grid grid-cols-3 items-center gap-8 sm:grid-cols-4 md:grid-cols-6 lg:gap-12">
            {[
              ...
              <div key={alt} className="flex items-center justify-center grayscale opacity-60 transition duration-300 hover:opacity-100 hover:grayscale-0">
                <img src={src} alt={alt} className="max-h-12 w-auto object-contain sm:max-h-16" />
              </div>
            ))}
          </div>
        </div>
