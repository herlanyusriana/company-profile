...
export default function AboutPage() {
  return (
    <main className="bg-white text-zinc-950">
      ...
      <section className="px-6 py-24 sm:px-10 lg:px-16 lg:py-32"><div className="mx-auto grid max-w-[1320px] gap-14 lg:grid-cols-2 lg:gap-24"><h2 className="text-5xl font-medium leading-[0.98] tracking-[-0.055em] sm:text-7xl">The details define the experience.</h2><div><p className="text-xl leading-8 text-zinc-600">PT CJ Trading delivers curated wellness, spa, and luxury living products for residential, hospitality, and commercial spaces across Indonesia.</p><p className="mt-6 leading-7 text-zinc-500">We work alongside architects, designers, developers, and homeowners—from product selection and technical coordination through delivery.</p><div className="mt-8 border-t border-zinc-200 pt-6"><p className="mb-3 text-xs uppercase tracking-[0.24em] text-zinc-500">Visit our showroom</p><p className="leading-7 text-zinc-600">Jakarta Design Center 4th Floor SR 15<br />Jl Gatot Subroto 53, Slipi, Jakarta 10260 Indonesia</p></div></div></div></section>
